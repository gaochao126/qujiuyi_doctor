...
public class PrescriptionDao extends DbBase {
	...
	private static final String INSERT_PRESCRIPTION = "INSERT `t_prescription`"
			+ "(`id`,`number`,`doctorId`,`patientId`,`relativeId`,`relativeName`,`relativeBirthday`,`relativeGender`,`allergies`,`illness`,`diagnosis`,`createTime`,`updateTime`,`status`,`price`,`type`,`payType`,`remark`,`version`,`remarkDate`,`relativeNation`,`sickHistory`,`phone`) "
			+ "VALUES(:id,:number,:doctorId,:patientId,:relativeId,:relativeName,:relativeBirthday,:relativeGender,:allergies,:illness,:diagnosis,:createTime,:updateTime,:status,:price,:type,:payType,:remark,:version,:updateTime,:relativeNation,:sickHistory,:patientPhone) ";
